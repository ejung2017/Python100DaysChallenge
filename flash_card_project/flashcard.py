...
try: 
    data = pd.read_csv("/Users/eunahjung/Desktop/Python100DaysChallenge/flash_card_project/data/french_words.csv")
except FileNotFoundError: 
    original_data = pd.read_csv("flash_card_project/data/french_words.csv")
    print(original_data)
...
def is_known():
    ...
    data.to_csv("flash_card_project/data/french_words.csv", index=False)
    next_card()
